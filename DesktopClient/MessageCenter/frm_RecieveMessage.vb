...
Public Class frm_RecieveMessage
    ...
    Private Sub 打开OToolStripButton_Click(sender As System.Object, e As System.EventArgs) Handles 打开OToolStripButton.Click
        getData(txtSerialNumber.Text, Format(Me.dtpStartDate.Value, "yyyy-MM-dd"), Format(Me.dtpEndDate.Value, "yyyy-MM-dd"), txtContent.Text)

    End Sub


    Public Sub getData(Optional SerialNumber As String = "", Optional Beginday As String = "1900-01-01", _
                            Optional EndDay As String = "2050-01-01", Optional Content As String = "")

        Dim df As New QueryData_Deletegate(AddressOf Query), sql As String
    ...
    Private Function Query_Compeleted(itfAR As IAsyncResult) As Integer
        ...
        Dim d As QueryData_Deletegate = ar.AsyncDelegate
        Try
    ...
    Private Sub ToolStripExport_Click(sender As System.Object, e As System.EventArgs) Handles ToolStripExport.Click
        ...
        _export.ExportData(ds.Tables(0), "", "", "接收短信")
    End Sub
    ...
    Private Sub rpt_MessageStatus_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.dtpStartDate.Value = Format(Now, "yyyy-MM-dd")
        Me.dtpEndDate.Value = Format(DateAdd(DateInterval.Day, 1, Now), "yyyy-MM-dd")
    End Sub
